...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    results = (dish_name, set(dish_ingredients))
    return results
...
def tag_special_ingredients(dish):
    ...
    allergies = set(dish[1]).intersection(SPECIAL_INGREDIENTS)
    results = (dish[0], allergies)
    return results
...
def separate_appetizers(dishes, appetizers):
    ...
    results = list(set(dishes).symmetric_difference(set(appetizers)))
    return results
...
def singleton_ingredients(dishes, intersection):
    ...
    all_ingredient = set()
    for dish in dishes:
        all_ingredient = all_ingredient.union(dish)
    results = all_ingredient - intersection
    return results
